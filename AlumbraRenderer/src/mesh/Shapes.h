...
public:
    Cube(const std::string& diffTexPath, const std::string& specTexPath = "");
    ~Cube();
...
public:
    Quad(const std::string& diffTexPath, const std::string& specTexPath = "");
    ~Quad();
};
...
const std::vector<Vertex> quadVertices{
    // Positions                            Normals                        Texture
    Vertex{glm::vec3(-5.0f, -0.5f,  5.0f),  glm::vec3(0.0f,  1.0f,  0.0f), glm::vec2(0.0f, 0.0f)},
    Vertex{glm::vec3(5.0f, -0.5f,  5.0f),  glm::vec3(0.0f,  1.0f,  0.0f), glm::vec2(2.0f, 0.0f)},
    Vertex{glm::vec3(-5.0f, -0.5f, -5.0f),  glm::vec3(0.0f,  1.0f,  0.0f), glm::vec2(0.0f, 2.0f)},

    Vertex{glm::vec3(-5.0f, -0.5f, -5.0f),  glm::vec3(0.0f,  1.0f,  0.0f), glm::vec2(0.0f, 2.0f)},
    Vertex{glm::vec3(5.0f, -0.5f,  5.0f),  glm::vec3(0.0f,  1.0f,  0.0f), glm::vec2(2.0f, 0.0f)},
    Vertex{glm::vec3(5.0f, -0.5f, -5.0f),  glm::vec3(0.0f,  1.0f,  0.0f), glm::vec2(2.0f, 2.0f)}
};
